...
ADD_PLAYLIST_ITEMS = Endpoint("POST", "/playlists/{playlist_ref}/items/add", None)
...
COPY_BETWEEN_PLAYLISTS = Endpoint(
    "POST", "/playlists/{source_playlist_ref}/{dest_playlist_ref}/items/copy", None
)
COPY_PLAYLIST_ITEMS = Endpoint("POST", "/playlists/{playlist_ref}/items/copy", None)
...
MOVE_BETWEEN_PLAYLISTS = Endpoint(
    "POST", "/playlists/{source_playlist_ref}/{dest_playlist_ref}/items/move", None
)
MOVE_PLAYLIST = Endpoint("POST", "/playlists/move/{playlist_ref}/{new_index}", None)
MOVE_PLAYLIST_ITEMS = Endpoint("POST", "/playlists/{playlist_ref}/items/move", None)
...
REMOVE_PLAYLIST_ITEMS = Endpoint("POST", "/playlists/{playlist_ref}/items/remove", None)
SET_CURRENT_PLAYLIST = Endpoint("POST", "/playlists", None)
SET_PLAYER_STATE = Endpoint("POST", "/player", None)
SORT_PLAYLIST_ITEMS = Endpoint("POST", "/playlists/{playlist_ref}/items/sort", None)
